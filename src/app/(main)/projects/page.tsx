...
export default function ProjectsPage() {
  ...
  const paginationControls = useMemo(() => {
    ...
    return (
      <div className="mt-8 flex justify-center gap-2">
        ...
        <span className="px-4 py-2 text-gray-300 bg-[#141428]/50 rounded-md border border-purple-900/50">
  ...
  const projectsList = useMemo(() => {
    ...
    if (filteredProjects.length === 0) {
      return (
        <div className="col-span-3 text-center py-10 bg-[#141428]/50 backdrop-blur-sm rounded-xl border border-purple-900/50 shadow-lg">
          <svg
