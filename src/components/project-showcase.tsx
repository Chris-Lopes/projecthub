      ...
      <div className="pt-10 md:pt-16">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full p-2 md:p-6">
            {/* Project Card 1 */}
            <div className="bg-slate-800/80 rounded-xl p-4 flex flex-col hover:bg-slate-700/80 transition-colors border border-slate-700/50 h-full">
              ...
              <div className="bg-teal-500/10 px-3 py-1 rounded-full w-fit mb-3">
              ...
              <Link
                ...
                className="mt-4 text-teal-400 text-sm flex items-center"
              >
                View Project
                <svg
